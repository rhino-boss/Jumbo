...
if True:
    ...
    def game_info_setting(game_setting):
        ...
        if gs.math_sts.game_type in [0, 1]:
    ...
    while gs.flag:
        ...
        if trigger_freegame_btn.on and gs.math_sts.game_type not in [0, 1]:
        ...
        for event in pg.event.get():
            ...
            if is_trigger_freegame_click and gs.lock_spin == False and gs.math_sts.game_type in [0, 1] and trigger_freegame_btn.on == False:
                gs.lock_spin = init_cnt(gs)
