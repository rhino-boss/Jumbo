...
class MathStatus:
    ...
    def __init__(self) -> None:
        # basic
        self.game_type = 0  # 0: base game, 1: free game, 2:...
...
def generate_fake_math_res_freegame():
    ...
    #
    math_res = MathResult(game_type, rng, arr_result, pay_lines, score, trigger_freespins, arr_result_sticky, pay_lines_sticky)
