...
* 可抽取的倍數為 `2x`、`3x`、`4x`、`5x`、`6x`、`8x`、`10x`、`12x`、`15x`、`20x`、`25x`、`50x`、`100x`、`1000x` 與 `2500x`。
* 該局若沒有 `C2`，則該局倍數視為 `1x`。
...
* 數值以 `H998192.xlsx`、`H998194.xlsx` 主 `Overview` 與其生成 config 為準；同一 Excel 內的歷史 Description 若衝突，不覆蓋主 Overview。
