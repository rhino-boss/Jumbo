...
| 規則說明 | 可出現的倍數為 X{2}、X{3}、X{4}、X{5}、X{6}、X{8}、X{10}、X{12}、X{15}、X{20}、X{25}、X{50}、X{100} 或 X{1000}。 | AVAILABLE MULTIPLIERS ARE X{2}, X{3}, X{4}, X{5}, X{6}, X{8}, X{10}, X{12}, X{15}, X{20}, X{25}, X{50}, X{100}, OR X{1000}. |
