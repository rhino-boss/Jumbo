...
| 規則說明 | Buy Feature 扣款為 100 × 玩家所選基礎 Bet，FG 獎金仍以該基礎 Bet 計算；使用保證觸發盤面進入一般 Free Game，該入口盤面只支付 Scatter 獎金，不支付一般符號獎金。本遊戲不提供 Super Feature。 | BUY FEATURE COSTS 100 × THE SELECTED BASE BET, AND FREE GAME WINS ARE CALCULATED FROM THAT BASE BET. IT USES A GUARANTEED TRIGGER GRID TO ENTER THE REGULAR FREE GAME; THAT ENTRY GRID PAYS ONLY THE SCATTER AWARD AND NEVER A REGULAR SYMBOL AWARD. SUPER FEATURE IS NOT AVAILABLE. |
