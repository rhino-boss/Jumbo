...
simulation_use_path = get_resource_path("Project/Slots/Source/General/Simulator/multiplier_range_v7.xlsx")
...
threshold_v6 = pd.read_excel(simulation_use_path, "v6_median", header=None, dtype=np.float32).values[:, 0]
threshold_v7 = pd.read_excel(simulation_use_path, "v7_99999999", header=None, dtype=np.float32).values[:, 0]

threshold_show = threshold_v7
threshold_record = threshold_v7  # 31, 32, ...
threshold_record_version = "threshold_v7"
