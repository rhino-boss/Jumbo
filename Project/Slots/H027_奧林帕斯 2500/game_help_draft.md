...
| 規則說明 | Free Game Spin 有一般符號得分時，最終盤面的 C2／C3 值才會加入累積倍數並立即作用於該次 Spin；只有 Scatter 得分或沒有得分時不累積。累積倍數跨 Spin 保留至整場 Free Game 結束。 | WHEN A FREE GAME SPIN HAS A REGULAR-SYMBOL WIN, THE FINAL C2 AND C3 VALUES ARE ADDED TO THE CARRYING MULTIPLIER AND APPLY TO THAT SPIN IMMEDIATELY. THEY ARE NOT ADDED ON A SCATTER-ONLY OR NO-WIN SPIN. THE CARRYING MULTIPLIER PERSISTS UNTIL THE FREE GAME ENDS. |
