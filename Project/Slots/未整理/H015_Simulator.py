...
def simulator_game(record_data, total_round):  # 完整遊戲模擬
    ...
    def free_game(num_c1_bg):  # log
        ...
        while True:
            ...
            log_all(num_c1_fg > 0, Box.RA_have_SC_FG, 1)
            log_all(num_c1_fg == 0, Box.RA_no_SC_FG, 1)
    ...
    for _ in range(total_round):
        ...
        if num_c1 >= 3:  # free game
            ...
            # if pay_BS / Box.default_coin_in > 10000:
            #     print(pay_BS / Box.default_coin_in)
            #     TT = True
        else:
        ...
        log_all(num_c1 >= 3, Box.RA_trigger_FG_pay_BG, pay_BS)
