...
class format_setting:
    ...
    def probability_and_period(value):
        """
        Examples
        --------
        >>> probability_and_round(0.210100)
        '0.2101% (約5場)'

        """
        return "{0:0.4f}% (約{1:0.0f}場)".format(value, 1 / value)
...
class div:
    ...
    def print_div___str___(div_str="", div_symbol="-", len=3, upper=False, lower=False):
        """
        Examples
        --------
        >>> print_div_____str_____()
        '------'
...
class log_use:
    ...
    def print_result2(*content, tag=">>> ", value_space=False, end_next_line=False):
        """
        Examples
        --------
        >>> print_result('aa', 10, 'bb', 20)
...
class Else:
    ...
    def get_value_by_weight(cum_weight):
        """
