...
| 文件 | 內容 |
|---|---|
| [開發流程.md](開發流程.md) | 數學開發流程、製作順序、階段關卡、各階段操作方式、重跑範圍、禁止事項與數學完成條件。 |
...
5. [模擬程式規範.md](模擬程式規範.md)：撰寫 Simulator 與產生 Config 前必讀。
6. [Demogame規範.md](Demogame規範.md)：製作 Demogame 前必讀。
