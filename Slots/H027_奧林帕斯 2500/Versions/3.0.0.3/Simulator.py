...
def play_base_spin_for_mode(table_id, profile_index, bet_mode, bet_multi):
    ...
    if bet_mode == MODE_FEATUREBUY:
        # BF entry only starts the feature.  Its four C1 do not award Scatter
        # pay, and the BF_Symbol stop is constructed to have no symbol win.
        return (0.0, 0.0, result[2], result[3], result[4], 0,
