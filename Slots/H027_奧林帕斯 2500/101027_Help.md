...
| 規則說明 | ▪ [C1] 獎金不乘倍數符號的倍數。 | ▪ [C1] WINS ARE NOT MULTIPLIED BY THE MULTIPLIER SYMBOLS. |
...
| 規則說明 | ▪ 同一最終盤面出現多顆 [C2]／[C3] 時，所有倍數相加，不相乘。 | ▪ WHEN SEVERAL [C2] / [C3] APPEAR ON THE SAME FINAL REELS, THEIR VALUES ARE ADDED TOGETHER, NOT MULTIPLIED. |
...
| 繁中 | 繁中 | 繁中 |
| --- | --- | --- |
| [M1] 12+ - 50 | [M2] 12+ - 25 | [M3] 12+ - 15 |
| [M1] 10–11 - 25 | [M2] 10–11 - 10 | [M3] 10–11 - 5 |
| [M1] 8–9 - 10 | [M2] 8–9 - 2.5 | [M3] 8–9 - 2 |
| [M4] 12+ - 12 | [A] 12+ - 10 | [K] 12+ - 8 |
| [M4] 10–11 - 2 | [A] 10–11 - 1.5 | [K] 10–11 - 1.2 |
| [M4] 8–9 - 1.5 | [A] 8–9 - 1 | [K] 8–9 - 0.8 |
| [Q] 12+ - 5 | [J] 12+ - 4 | [TE] 12+ - 2 |
| [Q] 10–11 - 1 | [J] 10–11 - 0.9 | [TE] 10–11 - 0.75 |
| [Q] 8–9 - 0.5 | [J] 8–9 - 0.4 | [TE] 8–9 - 0.25 |
...
| 規則說明 | ▪ 免費遊戲的倍數會累積，詳見免費遊戲特色。 | ▪ IN THE FREE GAME FEATURE THE MULTIPLIERS ACCUMULATE. SEE FREE GAME FEATURE. |
...
| 規則說明 | ▪ 免費遊戲使用與一般遊戲相同的中獎方式與連消規則。 | ▪ THE FREE GAME FEATURE USES THE SAME WIN EVALUATION AND CASCADE RULES AS THE BASE GAME. |
...
| 規則說明 | ▪ [C1] 獎金不乘累積倍數。 | ▪ [C1] WINS ARE NOT MULTIPLIED BY THE CARRYING MULTIPLIER. |
...
| 規則說明 | ▪ 直接進入免費遊戲，進場盤面固定出現 {4} 個 [C1]。 | ▪ IT ENTERS THE FREE GAME FEATURE DIRECTLY WITH EXACTLY {4} [C1] ON THE ENTRY REELS. |
...
| 規則說明 | ▪ 盤面出現 [C1] 時會打擊 OP JACKPOT 符號。 | ▪ [C1] ON THE REELS STRIKES THE OP JACKPOT SYMBOLS. |

> **待補**：`game_rule.md` 只定義了「[C1] 會打擊 OP JACKPOT 符號」，
> 沒有定義獎項階層（GRAND／MAJOR／MINOR／MINI）、揭獎方式、中獎條件與投注解鎖門檻。
> `Source/H027192A.xlsx` 的 `OP Jackpot` 工作表只有 SCR 貢獻門檻，不是玩家面規則。
> 依規範「Help 不得新增、刪除或改變正式遊戲規則」，此處不自行補寫。
> 需先在 `game_rule.md` 定義後再回填本區塊（格式可參考 H026 的 OP JACKPOT 區塊）。
